...
# Get the API key from the environment or use the hardcoded key
...
client = OpenAI(
    api_key=api_key,
    base_url=api_base or None  # Use None if api_base is an empty string
)
...
def gpt_usage(backend="gpt-4o-mini"):
    ...
    if backend == "gpt-4":
        ...
        cost = completion_tokens / 1000 * 0.005 + prompt_tokens / 1000 * 0.0025
    return {
